...
##### Use Case 1: Нарисовать прямоугольник
  ...
  - **Исключения:**
      - Если `x`, `y`, `width` или `height` не являются целыми числами или `width`/`height` ≤ 0, система выводит сообщение об ошибке и возвращается в меню.
...
##### Use Case 2: Нарисовать линию
  ...
  - **Исключения:**
      - Если любая из координат не является целым числом, система выводит сообщение об ошибке и возвращается в меню.
      - Если символ заливки не является одним символом, система выводит сообщение об ошибке и возвращается к меню.
...
##### Use Case 3: Нарисовать круг
  ...
  - **Исключения:**
      - Если `x`, `y` или `radius` не являются целыми числами или `radius` ≤ 0, система выводит сообщение об ошибке и возвращается к меню.
      - Если символ заливки не является одним символом, система выводит сообщение об ошибке и возвращается к меню.
...
##### Use Case 4: Переместить фигуру
  ...
  - **Исключения:**
      ...
      - Если `dx` или `dy` не являются целыми числами, система выводит сообщение об ошибке и возвращается к меню.
